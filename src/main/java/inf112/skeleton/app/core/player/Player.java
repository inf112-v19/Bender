...
public class Player<cardToAdd> implements IPlayer {
    ...
    public void update(Player player) {
        this.robot.setDirection(player.getRobot().getDirection());
        this.robot.setProgramCards(player.getRobot().getCardArray());
        this.setCards(player.getCards());
    }
    private void setCards(ArrayList<IProgramCard> cards) {
        this.cards = cards;
    }
